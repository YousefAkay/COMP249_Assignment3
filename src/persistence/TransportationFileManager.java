...
public class TransportationFileManager {
    ...
    // Example formats:
    // FLIGHT;TR3001;Company;Dep;Arr;Airline;850.00;23.0
    // TRAIN;TR3002;Company;Dep;Arr;TrainType;SeatClass;250.00
    // BUS;TR3003;Company;Dep;Arr;75.00;3
    public static void saveTransportations(Transportation[] arr, int count, String filePath) throws IOException {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (t instanceof Flight) {
                Flight f = (Flight) t;
                out.println("FLIGHT;" + f.getTransportId() + ";" + f.getCompanyName() + ";" + f.getDepartureCity() + ";" +
                        f.getArrivalCity() + ";" + f.getAirlineName() + ";" + f.getBaseFare() + ";" + f.getLuggageAllowanceKg());
            } else if (t instanceof Train) {
                Train tr = (Train) t;
                out.println("TRAIN;" + tr.getTransportId() + ";" + tr.getCompanyName() + ";" + tr.getDepartureCity() + ";" +
                        tr.getArrivalCity() + ";" + tr.getTrainType() + ";" + tr.getSeatClass() + ";" + tr.getBaseFare());
            } else if (t instanceof Bus) {
                Bus b = (Bus) t;
                out.println("BUS;" + b.getTransportId() + ";" + b.getCompanyName() + ";" + b.getDepartureCity() + ";" +
                        b.getArrivalCity() + ";" + b.getBaseFare() + ";" + b.getNumberOfStops());
            } else {
                // unknown subclass
